...
are proposing a design of. Motivate it a little bit, and tell a story. 

Appendix ~\ref{sec:pilot}.
...
each simulated censorship environment. 
 ...
 %% what we will recruit for, how we inform, and interactions.  
...
\item 5 questions regarding their experience
...
each task. {\color {red} This is because WHY?} %ask david exactly why--technically. isn't the first hop in the clear? 
...
\indent \indent {\color {red}  cite work which has made a huge impact on how people use it, and 
...
{\color {red}  GET THE LIST OF TASKS WE MADE THEM DO.}
...
\item 2 session and participant information questions
\item 4 basic demographics questions
\item 6 questions regarding their experience with Tor
\item 2 technical calibration questions
\item 4 Internet attitude questions
\end{itemize}
