...
Then our participants were instructed to complete the following tasks while performing a cognitive
walkthrough:

\begin{itemize} \itemsep1pt \parskip0pt \parsep0pt
\item Search for, download, and install Tor Browser
\item Do a web search for ``onions'' 
\item Watch an ``Ode to Joy'' video on youtube 
\item Use ``New Identity"
\item Interact with and describe what you think the browser toolbar buttons do
\end{itemize}
