...
We saw an SEO poisoning opportunity. 
...
at the top, which is `Download Tor'.''} -P
\end{quote}
...
but then it says `Tor Browser' just a little bit underneath, so I get, I put two and two together and I figure 
this is probably what I have to download.'}' -P3
\end{quote}
...
\begin{quote}{\it
``I am going to go to torproject.org... I am seeing the second result is `Download Tor.'
