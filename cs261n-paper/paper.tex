...
Because of the limited size of the study, it's not possible to state with confidence what 
...
The biggest usability struggle was the result of tensions between Mac's security feature 
and Tor's usability, rather than a specific feature of the Tor Browser itself. 
...
Through observing our participants, 
we believe visual elements into their user interface design may be the key to 
...
the advanced setting for Tor Browser, and were wary to user it, but explaining why an option 
tis available to the user may increase comprehension and tailored use.
