...
Something unexpected which interfered with Tor's usability is that Mac's usable 
security feature which prevents opening unsigned code made Tor much less usable.

Lessons learned: 
Leverage visuals and interface design to prioritize communication to users. Most of the 
important information was communicated with paragraphs of text that users actively 
communicated that they did not read or did not want to read and only read because of 
issues they were experiencing. 

Most participants did not have any interest or comprehension for advanced features.
In usability literature, it is good to just configure these for users, but Tor does not track
information on users. Maybe it's good to have failsafe defaults and less options. 

Quotes: 

SEO poisoning opportunity: 

`` I'm going to use Chrome, because that's what I use at home...
...
at the top, which is `Download Tor'.'' -P1 

``Okay. So I just would type in `tor' in the uh search engine and `Tor Project'...
`Anonymity Online'... I guess this is it. And I click. And the there is a "Download Tor", 
so I am going to click this.'' -P2

``There's, like, the first thing on the page is called the Tor Project, and I wouldn't figure out what that is,
but then it says `Tor Browser' just a little bit underneath, so I get, I put two and two together and I figure this is probably what I have to download.'' -P3

``so I am going to type in `tor mac download.'
And that gives me some suggestions. I pick the first one.'' -P4

``I am seeing the second result is `Download Tor.'
That might save a few steps, I will click on that.'' -P5

On using visuals and emphasis: 

``...it looks like I should click there, because it is purple. No, not because it's purple, but... 
[laughter] because it has that little cloud with the arrow... and you can't click anywhere else to download.'' -P1 
...
There are a couple of other small words on the screen that I'm not going to look at, because this seems like the most obvious thing to do.'' -P3

"Don't open documents downloaded through Tor... That doesn't make sense to me.
But I'll just pay attention because it's in capitals and it's like they're yelling at me.'' -P1
...
Grr! I express some frustration at this fact.'' - P4
...
usually it's out of my understanding.'' -P5

``Oh, hey! There's the onion menu. That was not obviously defined at all!'' -P4
...
from your Gmail account and everything, you can type that as a different user.'' -P3 
