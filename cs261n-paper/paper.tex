...
at the top, which is `Download Tor'.''} \mbox{---P}
\end{quote}
...
this is probably what I have to download.'}' \mbox{---P3}
\end{quote}

\begin{quote}{\it
``\ldots so I am going to type in `tor mac download'.
And that gives me some suggestions. I pick the first one.''} \mbox{---P4}
\end{quote}
...
\begin{quote}{\it
``Don't open documents downloaded through Tor\ldots\ That doesn't make sense to me.
But I'll just pay attention because it's in capitals and it's like they're yelling at me.''} \mbox{---P1}
\end{quote}
